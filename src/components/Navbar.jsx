          ...
          >
            ...
            <nav className="hidden lg:flex items-center gap-1 bg-white/[0.03] border border-white/10 p-1.5 rounded-full backdrop-blur-md relative">
              {!isArtifactsPage ? (
                    ...
                    >
                      {isHome ? (
                        <ScrollLink
                          ...
                          className={`relative z-10 px-4 py-1.5 text-xs font-bold uppercase tracking-wider transition-all duration-300 cursor-pointer block ${
                        ...
                        <button
                          ...
                          className="relative z-10 px-4 py-1.5 text-xs font-bold uppercase tracking-wider text-white/60 hover:text-white transition-all duration-300 block"
                        >
                          <motion.span whileHover={{ y: -1 }} className="block">
                            {link.name}
                          </motion.span>
                ...
                <RouterLink
                  to="/#projects"
                  className="flex items-center gap-2 px-4 py-1.5 text-xs font-bold uppercase tracking-wider text-dark-primary hover:text-white transition-colors"
                >
            ...
            <div className="flex items-center gap-3 shrink-0">
              ...
              <div className="hidden sm:block">
                <MagneticButton>
                  {isHome ? (
                    <ScrollLink to="contact" smooth offset={-80} duration={800}>
                      <motion.button
            ...
            <div className="fixed inset-0 z-[115] flex items-center justify-center p-4 lg:hidden pointer-events-none">
              ...
              >
                  ...
                  {navLinks.map((link, i) => (
                    ...
                    >
                      {isHome ? (
                        ...
                        <button
                          onClick={() => handleNavClick(link.to)}
                          className="flex items-center justify-between w-full px-5 py-3.5 rounded-2xl text-sm font-bold uppercase tracking-wider text-white/70 hover:text-white hover:bg-white/10 transition-all text-left group"
                        >
                          <span>{link.name}</span>
                          <ChevronRight size={16} className="text-white/30 group-hover:translate-x-1 group-hover:text-dark-primary transition-all" />
                        </button>
                ...
                <div className="pt-4 border-t border-white/10 flex flex-col gap-3">
                  <ScrollLink to="contact" smooth offset={-80} duration={800} onClick={closeMenu}>
                    <motion.button
