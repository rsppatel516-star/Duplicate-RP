...
export const featuredArtifacts = [
  {
    ...
    keyFeatures: [
      ...
      'Global ambient aurora mesh background system',
    ...
    solution: 'Implemented a motion-first architecture using Framer Motion and a global ambient light mesh background to create an immersive "Midnight Glass" aesthetic.',
